...
const autoCompletejs = new autoComplete({
	data: {
		src: async () => {
			...
			document
				.querySelector("#autoComplete")
				.setAttribute("placeholder", "Start typing item codes/names here...");
	...
	placeHolder: "Start typing item codes/name here...",
	...
	onSelection: feedback => {
        ...
        const time_readable = time.toLocaleDateString("en-US", options);
